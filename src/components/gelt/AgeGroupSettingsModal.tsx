...
export function AgeGroupSettingsModal({
  group,
  onClose,
}: AgeGroupSettingsModalProps) {
  ...
  const calculateImpact = () => {
    ...
    return {
      difference,
      percentageChange:
        currentTotal > 0 ? (difference / currentTotal) * 100 : 0,
    };
  };
            ...
            <div className="bg-gray-50 rounded-md p-3">
              ...
              <div className="mt-2 space-y-1">
                ...
                {impact && (
                  <p
                    className={`text-sm ${
                      impact.difference > 0 ? 'text-green-600' : 'text-red-600'
                    }`}
                  >
